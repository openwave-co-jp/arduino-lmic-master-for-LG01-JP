Arduino-LMIC library for LG01-JP
================================
This library is customize for Dragino LG01-JP.
Reference is https://github.com/mcci-catena/arduino-lmic.

このライブラリは、Dragino社のLG01-JP用にカスタマイズした、LMiCのライブラリです。
元のプログラムは、こちら（https://github.com/mcci-catena/arduino-lmic）になります。
